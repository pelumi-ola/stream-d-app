...
export default function ReturningUserSubscribePage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-400 via-purple-500 to-purple-600 flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md bg-white rounded-3xl p-8 shadow-2xl">
          ...
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-4">You are Subscribing With</label>

              <div className="flex items-center space-x-3 mb-4">
                <div className="text-purple-500 text-lg">📞</div>
                <span className="text-lg font-medium text-gray-800">09030002783</span>
              </div>

              <Link href="/subscribe" className="text-blue-600 hover:text-blue-800 text-sm font-medium">
                Use Another Number
              </Link>
            </div>
      ...
      <div className="flex-1 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-400 via-purple-500 to-pink-500">
          <img
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/STREAM%20D%20_Returning%20User%20Subcription%20PAGE-BQ8RZ.png"
